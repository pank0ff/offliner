            ...
            <div class="col-md-8 col-lg-8">
                <div class="d-flex flex-column">
                    <div class="d-flex flex-row justify-content-between align-items-center p-5 bg-black text-white">
                        <h3 class="display-5">${user.getUsername()}</h3><i class="fa fa-facebook">facebook</i><i class="fa fa-google">google</i><i class="fa fa-youtube-play">youtube</i><i class="fa fa-dribbble">dribble</i><i class="fa fa-linkedin">linkedin</i>
                    </div>
        ...
        <#list messages as message>
            <div class="card my-3" >
                ...
                <div >
                    ...
                    <div>
                    <a class="nav-link" style="color: cornflowerblue" href="/post/${message.id}"> Read full</a>
                    </div>
              </div>
                     <div>
                         <#if admin>     <a class="nav-link" style="color: cornflowerblue"  href = "/post/${message.id}"> Read full</a><a class="nav-link" style="color: cornflowerblue" href="/user/profile/update/${message.id}">Edit</a>
                         </#if>
                     </div>
